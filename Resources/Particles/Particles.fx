...
cbuffer cb0
{
    ...
    float4x4 g_mInvView : ViewInverse;
    float g_fGlobalTime : GlobalTime;
    float g_fElapsedTime : ElapsedTime;
    float4 g_vFrameGravity : FrameGravity;
    float g_fSecondsPerFirework = .4f;
    int g_iNumEmber1s = 100;
...
Texture2D g_txDiffuse : DiffuseTexture;
...
Texture1D g_txRandom : RandomTexture;
