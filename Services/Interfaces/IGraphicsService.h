...
public:
	...
	virtual void PrepareShadowGeneration(void)=0;
	virtual void GenerateShadows(resource_ptr<Model3D> pModel, const tt::Matrix4x4& worldMat, resource_ptr<Material> pMat, const tt::GameContext& context)=0;
	...
	virtual RenderTarget2D* GetShadowMapRenderTarget() const=0;
